...
class _LoanReviewDetailsPageState extends State<LoanReviewDetailsPage> {
    ...
    try {
      ...
      final staffId = staffRecord['id'] as int;
        ...
        if (status == 'Approved') {
          ...
          // Notifications are surfaced by the app notification list (approved_loans entry)
          ...
          // Notifications are surfaced by the app notification list (loan_application status)
  ...
  // Notifications are generated by the app notification system; no edge call.
